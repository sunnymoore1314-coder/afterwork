...
const messages: Record<Language, Record<string, string>> = {
  en: {
    headerNote:"A little space for yourself", footerLeft:"Made for the hours that belong to you.", footerRight:"Less doing. More being.", homeLabel:"Afterwork home", historyNav:"History",
    ...
    historyEyebrow:"YOUR RECENT EVENINGS", historyTitle:"Saved plans", historyIntro:"Up to 10 plans are kept only in this browser.", historyEmptyTitle:"No saved plans yet.", historyEmptyText:"Your next imported plan will appear here.", clearAll:"Clear all", clearConfirm:"Remove all saved plans from this browser?", favorite:"Add to favorites", unfavorite:"Remove from favorites", delete:"Delete plan", reuse:"Use these choices", openPlan:"Open plan",
    startPlan:"Start tonight’s plan", focusEyebrow:"TONIGHT, ONE STEP AT A TIME", progress:"Progress", now:"NOW", done:"Done", skip:"Skip", undo:"Undo", copyPlan:"Copy plan", noActiveTitle:"There is no active plan.", noActiveText:"Open a plan and start it when you are ready.", completeEyebrow:"YOUR WORKDAY CAN END HERE", completeTitle:"You made a little room for yourself.", resetProgress:"Start again", newPlan:"Make another plan"
  },
  zh: {
    headerNote:"给自己留一点空间", footerLeft:"献给真正属于你的下班时间。", footerRight:"少做一点，多感受一点。", homeLabel:"Afterwork 首页", historyNav:"历史",
    ...
    historyEyebrow:"最近的夜晚", historyTitle:"保存的计划", historyIntro:"最多保存 10 份计划，数据只留在当前浏览器。", historyEmptyTitle:"还没有保存的计划。", historyEmptyText:"下一份导入的计划会出现在这里。", clearAll:"清空全部", clearConfirm:"确定删除浏览器中的全部计划吗？", favorite:"收藏", unfavorite:"取消收藏", delete:"删除计划", reuse:"沿用条件", openPlan:"打开计划",
    startPlan:"开始今晚的计划", focusEyebrow:"今晚，一次只做一步", progress:"进度", now:"当前", done:"完成", skip:"跳过", undo:"撤销", copyPlan:"复制计划", noActiveTitle:"当前没有执行中的计划。", noActiveText:"打开一份计划，准备好后就可以开始。", completeEyebrow:"今天的工作可以停在这里", completeTitle:"你为自己留出了一点空间。", resetProgress:"重新开始", newPlan:"制定新计划"
  }
};
