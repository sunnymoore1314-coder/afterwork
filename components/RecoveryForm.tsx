...
async function submit(event:React.FormEvent<HTMLFormElement>){
 ...
 if(!context.success){setError("Please check your choices and start time.");setLoading(false);submitting.current=false;return}
 if(usesManualPlanner()){
  try{sessionStorage.setItem("afterwork-context",JSON.stringify(context.data));router.push("/manual")}
  catch{setError("Your browser could not keep these choices for this tab.");setLoading(false)}
